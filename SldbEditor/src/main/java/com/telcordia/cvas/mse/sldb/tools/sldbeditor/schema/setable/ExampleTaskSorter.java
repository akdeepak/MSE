...
public class ExampleTaskSorter extends ViewerSorter {
    ...
    public int compare(Viewer viewer, Object o1, Object o2) {
        ...
        SchTask task1 = (SchTask) o1;
        SchTask task2 = (SchTask) o2;
     ...
     */
    private int comparePercentComplete(SchTask task1, SchTask task2) {
     ...
     *  element is greater than the second element
     */
    protected int compareDescriptions(SchTask task1, SchTask task2) {
     ...
     *  element is greater than the second element
     */
    protected int compareOwners(SchTask task1, SchTask task2) {
    ...
    static final String[] WHAT_STRING = new String[] {
            ...
            "All Rights Reserved.",
            "@(#) $URL: http://jcvas.iscp.telcordia.com:8080/src/trunk/delivered/MSE/SDP/SldbEditor/src/main/java/com/telcordia/cvas/mse/sldb/tools/sldbeditor/schema/setable/ExampleTaskSorter.java $ $Rev: 50389 $ $LastChangedBy: dkarunan $ $Date: 2011-09-17 12:18:35 +0530 (Sat, 17 Sep 2011) $" };
